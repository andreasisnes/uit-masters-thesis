...
The following tables shows lines of code in each project, and it was calculated by using a tool called \texttt{loc}. It seems like docstrings in Python is counted as a code line and not as a comment.
